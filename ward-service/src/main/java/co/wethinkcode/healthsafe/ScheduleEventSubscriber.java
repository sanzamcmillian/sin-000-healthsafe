...
import co.wehinkcode.healthsafe.StaffingInfoStore;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.apache.activemq.ActiveMQConnectionFactory;

import javax.jms.*;

public class ScheduleEventSubscriber {
    ...
    private void parseAndStore(String json) throws Exception {
        ...
        int alertLevel = rootNode.path("alertLevel").asText();
        int doctorCount = rootNode.path("doctorCount").asText();
